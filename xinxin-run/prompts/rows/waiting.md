Create a single horizontal sprite strip for the Codex app digital pet `xinxin` in the state `waiting`.
...
Xinxin personality direction: make waiting feel patient and caring. Use a slight side-to-side sway, a soft blink, a tiny hand clasp or relaxed hand shift, subtle hair/skirt movement, and a sweet smiling expression as if she is quietly humming while waiting. Keep the feet planted and the motion soothing. Do not add music notes, text, symbols, or speech bubbles.
