Create a single horizontal sprite strip for the Codex app digital pet `xinxin` in the state `waving`.
...
Xinxin personality direction: make the wave feel warm and encouraging. Use a small raised hand gesture, a bright smiling face, and a slight rhythmic hair/skirt sway like she is greeting someone between little songs. Show the wave only through arm and hand pose; no wave marks, music notes, text, or floating symbols.
