Create a single horizontal sprite strip for the Codex app digital pet `xinxin` in the state `jumping`.
...
Xinxin personality direction: make the jump a delicate happy hop with a soft skirt flutter and hair lift. She loves laughing and singing, so make the peak frame especially joyful with a bigger smile or tiny cheerful open-mouth expression. Keep it elegant and compact, with no floor cue, dust, shadow, impact effect, music notes, text, or symbols.
