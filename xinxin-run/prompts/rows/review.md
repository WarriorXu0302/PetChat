Create a single horizontal sprite strip for the Codex app digital pet `xinxin` in the state `review`.
...
Xinxin personality direction: make review feel thoughtful and supportive. Use a slight forward lean, careful eye movement, soft blink, tiny nod, and a soft encouraging smile, as if she is checking something gently while quietly humming. Do not add magnifying glasses, documents, UI, music notes, symbols, speech bubbles, or text.
