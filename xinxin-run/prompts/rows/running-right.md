Create a single horizontal sprite strip for the Codex app digital pet `xinxin` in the state `running-right`.
...
Xinxin personality direction: make the locomotion light, graceful, and lively rather than athletic. Use tiny steps, a buoyant body bob, hair and skirt trailing slightly with the motion, and a bright smiling expression as if she is happily humming while moving. Preserve the side bow and necklace consistently. Do not add music notes, text, symbols, or detached effects.
